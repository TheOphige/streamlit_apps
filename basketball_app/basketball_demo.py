...
st.title('NBA Playerr Stats Explorer')
...
@st.cache
def load_data(year):
    url= "https://www.basketball-reference.com/leagues/NBA_" + str(year) + "_per"
...
st.write('Data Dimension: ' + str(df_selected_team[0])
...
if st.button('Intercorrelation Heatmap'):
    st.header("Intercorrelattion Matrix Heatmap")
