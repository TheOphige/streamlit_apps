...
lottie_penguin = load_lottieurl(
    "https://assets1.lottiefiles.com/private_files/lf30_lntyk83o.json"
)
st_lottie(lottie_penguin, speed=1.5, width=750, height=200)
...
if [island, sex, bill_length, bill_depth, flipper_length, body_mass] == [
    "Biscoe",
    "Female",
    0,
    0,
    ...
    st.write(
        "- Your inputs are {} ".format(
            [island, sex, bill_length, bill_depth, flipper_length, body_mass]
        )
    )

    st.write(
        "- We predict your penguin is of the {} species".format(prediction_species)
    )
